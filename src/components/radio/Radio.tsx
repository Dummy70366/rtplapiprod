...
const Radio = (props: CheckBoxProps) => {
  return (
    <>
      <div
        className={`${props.parentClass ? props.parentClass : ""
          } relative flex`}
      >
        <input
          type="radio"
        ...
        <label
          ...
          className={`text-sm/18px text-black/50 font-semibold max-w-[calc(100%_-_16px)] cursor-pointer pl-2 ${props.labelClass ? props.labelClass : ""
            }`}
        >
          {props.label}
        </label>
