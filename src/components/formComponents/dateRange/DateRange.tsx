      ...
      <div className={`${props.parentClass ? props.parentClass : ""} relative`}>
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center">
            <label className="block text-13px/4 text-left font-semibold whitespace-nowrap mr-6px">
              Start Date
            </label>
            <div className="relative">
              <ReactDatePicker
                className={`py-11px px-15px pr-6 bg-transparent text-sm/18px font-semibold text-black placeholder:text-black/50 w-full border border-solid border-customGray/20 rounded-10 transition-all duration-300  focus:ring-2 focus:ring-customGray/30 focus:ring-offset-2 ${
